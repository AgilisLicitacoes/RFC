...
% \usepackage{listings}   % Permite inserir código
...
\titulo{Agilis - Leitor e Interpretador de Licitações com Inteligência Artificial}%

\autor{Maruan {}Biasi El Achkar}%
\orientador{Marisangila{}Alves}%
...
\preambulo{Trabalho de Conclusão de Curso apresentado ao Curso de Engenharia de Software do Centro Universitário – Católica de Santa Catarina, como requisito parcial para a obtenção do grau de Bacharel em Engenharia de Software.}
...
\include{Textuais/Descricao}
\include{Textuais/Especificacoes}
% \include{Textuais/ProximosPassos}
% \include{Textuais/Exemplos}
% -----------------------------------------------------------------
...
\include{PosTextuais/FolhaAvaliacao}
